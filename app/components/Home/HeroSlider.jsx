  ...
  return (
    <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[800px]">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 bg-black/40 px-4 md:px-6 py-8 md:py-0 text-center">
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold max-w-3xl leading-tight text-white">
          {data.title}
        </h2>
        <p className="text-sm sm:text-base md:text-xl mt-3 md:mt-4 max-w-2xl px-4 text-white/90">
          {data.subtitle}
        </p>
        <Button
          href={data.ctaLink}
