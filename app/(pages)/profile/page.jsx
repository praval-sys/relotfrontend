                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 w-full">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-r from-red-500 to-red-600 text-white flex items-center justify-center text-xl sm:text-2xl font-bold mx-auto sm:mx-0">
                        {profile?.name?.[0]?.toUpperCase() || '?'}
                      </div>
                      <div className="flex-1">
                        <h2 className="text-lg sm:text-xl font-semibold text-gray-900">{profile?.name}</h2>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-colors text-sm sm:text-base w-full sm:w-auto justify-center"
                    >
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors font-medium text-sm sm:text-base w-full sm:w-auto justify-center"
                    >
                    ...
                    {addressLoading && !isAddingAddress && !editingAddress ? (
                        ...
                        addresses.map((address) => {
                            ...
                            return (
                                <div 
                                    key={address.id}
                                    className="border border-gray-200 rounded-xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-start gap-3 hover:shadow-sm transition-shadow"
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-700 mb-1 leading-relaxed text-xs sm:text-base">{mainAddress}</p>
                                        <p className="text-gray-600 mb-1 text-xs sm:text-base">{cityState}</p>
                                        {address.phoneNumber && (
                                          <p className="text-gray-500 text-xs sm:text-sm">📞 {address.phoneNumber}</p>
                                        )}
