  ...
  const bespokeServices = [
    {
      ...
      icon: <Pencil className="h-12 w-12 text-red-600" />
    },
    {
      ...
      icon: <Compass className="h-12 w-12 text-red-600" />
    }
  ];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-purple-50 border border-purple-100 p-6 rounded-lg mb-12">
          <div className="flex items-center justify-between">
            ...
            <button className="bg-red-600 text-white px-6 py-2 rounded-md hover:bg-red-700 transition-colors duration-200" onClick={() => window.location.href = '/contactus'}>
              Contact Us
            </button>
          </div>
        </div>
